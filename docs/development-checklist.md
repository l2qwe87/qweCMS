...
- [x] Создать `MixinController` с эндпоинтами (GET, POST, PUT, DELETE)
- [x] Создать `MixinService` с бизнес-логикой
- [x] Реализовать валидацию JSON Schema миксинов
- [x] Добавить пагинацию для списка миксинов
- [x] Реализовать поиск и фильтрацию
- [x] Добавить обработку ошибок

### 7. Реализовать CRUD API для схем
- [x] Создать `SchemaController` с эндпоинтами (GET, POST, PUT, DELETE)
- [x] Создать `SchemaService` с бизнес-логикой
- [x] Реализовать валидацию связей с миксинами
- [x] Добавить эндпоинт для получения скомпонованной схемы
- [ ] Реализовать проверку циклических зависимостей
- [ ] Добавить soft delete для схем

### 8. Реализовать сервис компоновки схем
- [x] Создать `SchemaCompositionService`
- [x] Реализовать JSON Pointer парсер
- [x] Добавить компоновку схем из миксинов
- [x] Реализовать валидацию путей миксинов
- [x] Добавить кеширование скомпонованных схем
- [x] Создать unit тесты для компоновки

### 9. Создать интерфейс управления миксинами
- [x] Создать `MixinListComponent` с таблицей миксинов
- [x] Создать `MixinFormComponent` для создания/редактирования
- [ ] Добавить JSON Schema редактор
- [ ] Реализовать предпросмотр миксина
- [x] Добавить валидацию на клиенте
